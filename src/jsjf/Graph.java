...
/** This program will demonstrate graphs by using an adjacency matrix to
 * show edges between vertices.
 * To run this program, enter the size of the adjacency matrix to test
 * then enter two digits representing the vertices to add an edge inbetween.
 *
 * Completed by James Behnke
 * TRU Student Number: t00532846
 * @param <T>
 */
...
public class Graph<T> implements GraphADT<T>
{
    ...
    public void removeEdge(int index1, int index2)
    {
        ...
        if (indexIsValid(index1) && indexIsValid(index2)) {
            //Switch indexes containing edges to false
